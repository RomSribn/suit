...
const makeImages: MakeImages = (imageProperties, context, sourceCommon) => {
    ...
    `${garment}/${fabric.replace(/(\.)(\/)/, '_')}/${subgroup}`; // ${id}/1600x1600/`;
...
type imagesFunction = (i: number, previewElement: ActivePreviewElement) => HTMLImageElement | null // tslint:disable-line
    ...
    componentWillReceiveProps(nextProps: P) {
        ...
        if (order !== this.props.order) {
            ...
            try {
                shirt = {
                    garment: 'shirt',
                    fabric: order!.shirt[0].fabric_ref.fabric,
                    subgroup: 'collars',
