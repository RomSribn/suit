...
const NavlinksComponent: React.FunctionComponent<NavlinksComponentProps> = ({
  isAuth,
  garment,
  lang,
}) => {
...
export { NavlinksComponent as Navlinks, NavlinksComponentProps };
