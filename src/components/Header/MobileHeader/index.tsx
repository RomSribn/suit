...
const makeNavLinkItem = (active: boolean) => (
  <span className={classnames('navlinks-mobile__item', active && '_active')} />
);
...
export default inject(({ garments: { garments } }) => {
  ...
  observer(
    ({ openMenu, lang, isLandscape, isAuth, activeGarments, path }: Props) => {
      return (
                    ...
                    component={(
                      ...
                      return (
                        <div className="navlinks-mobile__container">
                          {makeNavLinkItem(
                            props.match.params.group === 'fabric_ref',
                          )}
                          {makeNavLinkItem(
                            props.match.params.group === 'design',
                          )}
                          {makeNavLinkItem(
                            props.match.params.group === 'fitting',
                          )}
                        </div>
                      );
                    }}
