...
const Controls = () => {
  return (
    <div className={`controls controls--gray`}>
...
let userImage =
  'https://pp.userapi.com/c840337/v840337301/3c1f7/F1sRUtxR5Hs.jpg';

const SettingsMeasures = inject('garments')(
  observer((props) => {
    return (
      <section className="settings-measures">
          ...
          >
            <div className="user-info_container">
              ...
              <div className="user-info__contacts">
                <span className="user-info_email">email@mail.com</span>
                <br />
                <span className="user-info_tel">+7 (495) 234-12-34</span>
                <br />
