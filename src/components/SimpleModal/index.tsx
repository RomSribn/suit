      ...
      <PopUp open={show} onClose={this.onClickButton}>
        <div
          className={classNames(baseClassName, {
            [baseClassName + '_small']: isSmall,
            [baseClassName + '_transparent']: isTransparent,
          })}
        >
          <div className="simple-modal">
            <div className="title-wrapper">
              <p
                className={classNames('title-text', {
                  ['title-text_black']: isTransparent,
                })}
              >
                {title}
              </p>
            ...
            <div className="desc-wrapper">
              <p
                className={classNames('desc-text', {
                  ['desc-text_black']: isTransparent,
                })}
              >
                {desc}
              </p>
            </div>
            <div className="buttons-wrapper">{this.renderButtons(buttons)}</div>
          </div>
        </div>
      </PopUp>
    );
