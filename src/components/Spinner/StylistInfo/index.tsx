...
import { StylistInfo as StylistInfoComponent, StylistInfoComponentProps } from './salons';
...
export const StylistInfo =
    // @ts-ignore
    StylistInfoClass as React.FC<Omit<StylistInfoComponentProps, keyof ReturnType<typeof injector>>>;
