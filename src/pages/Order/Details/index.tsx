...
class Main extends React.Component<DetailsContainerProps> {
  render() {
    const { activeGarmentsStore, lang, garments } = this.props;
    const activeGarments = activeGarmentsStore.map((g: string) => ({
      id: g,
      link: g,
    ...
    return <Component lang={lang} activeGarments={[...activeGarments]} />;
  }
}
