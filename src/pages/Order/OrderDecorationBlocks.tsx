...
const Demo = () => (
  ...
  >
    <div className="main-page-title__wrap">
      <div className="main-page-title__row" id="js-word-1">
        {
          <img
      ...
      <div className="main-page-title__row" id="js-word-2">
        {
          <img
            className="main-page-title__slogan-parts"
      ...
      <div className="main-page-title__row" id="js-word-3">
        {
          <img
            className="main-page-title__slogan-parts"
